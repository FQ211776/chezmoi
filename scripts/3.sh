...
dependencias=(alacritty base-devel brightnessctl bspwm dunst feh firefox geany git kitty imagemagick jq \
                    ...
                    wezterm ttf-nerd-fonts-symbols-mono python-nautilus noto-fonts-emoji xsel micro) 
is_installed() {
    pacman -Q "$1" &> /dev/null
}
...
aur_dependencias=(ttf-meslo-nerd zoxide-git flutter gitkraken localsend siji-ng ttf-unifont noto-color-emoji-fontconfig xorg-fonts-misc ttf-dejavu ttf-meslo-nerd-font-powerlevel10k noto-fonts-emoji powerline-fonts  microsoft-edge-stable-bin microsoft-edge-beta-bin bcompare) 
