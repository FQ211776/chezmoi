...
########## --------- Changing shell to zsh ---------- ##########
    ...
    if [ -d "$HOME/$folder" ]; then
        ...
        sleep 2
        echo
        sudo pacman -S --needed --noconfirm zsh grml-zsh-config fastfetch wget
        paru -S --noconfirm --needed ttf-meslo-nerd siji-git ttf-unifont noto-color-emoji-fontconfig xorg-fonts-misc ttf-dejavu ttf-meslo-nerd-font-powerlevel10k noto-fonts-emoji powerline-fonts zsh-theme-powerlevel10k
...
#     gum style --foreground 35 "5. configurar ZSH y Fish."
